# NOTE:
# This is a modified PagesController from refinerycms-pages gem,
# accomodated to handle pages that require a member to be logged in.
# The only change made so far is the one in "current_user_can_view_page?".
# If you have your own copy of PagesController,
# make sure to add a check for page.need_login? and member_signed_in?
# where appropriate.
...
module Refinery
  ...
  protected
    ...
    def current_user_can_view_page?
      return false if page.need_login? && !member_signed_in?
